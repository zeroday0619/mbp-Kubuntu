...
curl -L https://github.com/AdityaGarg8/T2-Big-Sur-Ubuntu-Kernel/releases/download/vKVER-1/linux-headers-KVER-t2-big-sur_KVER-1_amd64.deb > /tmp/headers-bs.deb
curl -L https://github.com/AdityaGarg8/T2-Big-Sur-Ubuntu-Kernel/releases/download/vKVER-1/linux-image-KVER-t2-big-sur_KVER-1_amd64.deb > /tmp/image-bs.deb
file /tmp/*
