...
curl -L https://github.com/AdityaGarg8/T2-Big-Sur-Ubuntu-Kernel/releases/download/v5.15.7-1/linux-headers-5.15.7-t2-big-sur_5.15.7-1_amd64.deb > /tmp/headers-bs.deb
curl -L https://github.com/AdityaGarg8/T2-Big-Sur-Ubuntu-Kernel/releases/download/v5.15.7-1/linux-image-5.15.7-t2-big-sur_5.15.7-1_amd64.deb > /tmp/image-bs.deb
file /tmp/*
