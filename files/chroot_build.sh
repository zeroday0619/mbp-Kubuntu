...
curl -L https://github.com/AdityaGarg8/T2-Mojave-Ubuntu-Kernel/releases/download/v5.15.6-1/linux-headers-5.15.6-t2-mojave_5.15.6-1_amd64.deb > /tmp/headers-m.deb
curl -L https://github.com/AdityaGarg8/T2-Mojave-Ubuntu-Kernel/releases/download/v5.15.6-1/linux-image-5.15.6-t2-mojave_5.15.6-1_amd64.deb > /tmp/image-m.deb
file /tmp/*
